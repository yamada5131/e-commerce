                ...
                <div
                    ...
                    <div class="pt-6">
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            ...
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{$product->user_reviews_avg_rating}}</p>
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">({{$product->user_reviews_count}})</p>
                        </div>
